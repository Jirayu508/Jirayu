...
import time
    ...
    #เนื่องจาก BeautifulSoup เป็น pip ที่ error บ่อยเหลือเกินแถมตัว Interpreter มีปัญหาในการโหลด ผมเลยเปลี่ยนเป็น Selenium แทน

        #***  ก่อน Run Code กรุณาใส่ command นี้ใน cmd หรือ Terminal ใน VSC ด้วย -> ""pip install selenium""  ***
        #ลอกสิรวิชญ์มาครับ :)
...
label = ttk.Label(frame, text="ผลสลากกินแบ่งรัฐบาล", font=("Kanit", 32, "bold"))
label.pack(pady=10)
